...
const inlineKeyboard = {
    f_1: [
        [
            { text: '1-Fasl', callback_data: 'd1_fasl_1' },
            { text: '2-Fasl', callback_data: 'd1_fasl_2' }
        ],
        [
            { text: '1', callback_data: 'd1_f_1_q_1' },
            { text: '2', callback_data: 'd1_f_1_q_2' },
            { text: '3', callback_data: 'd1_f_1_q_3' },
            { text: '4', callback_data: 'd1_f_1_q_4' },
            { text: '5', callback_data: 'd1_f_1_q_5' },
        ],
        [
            { text: '6', callback_data: 'd1_f_1_q_6' },
            { text: '7', callback_data: 'd1_f_1_q_7' },
            { text: '8', callback_data: 'd1_f_1_q_8' },
            { text: '9', callback_data: 'd1_f_1_q_9' },
            { text: '10', callback_data: 'd1_f_1_q_10' },
        ], [
            { text: '11', callback_data: 'd1_f_1_q_11' },
            { text: '12', callback_data: 'd1_f_1_q_12' },
            { text: '13', callback_data: 'd1_f_1_q_13' },
            { text: '14', callback_data: 'd1_f_1_q_14' },
            { text: '15', callback_data: 'd1_f_1_q_15' },
            { text: '16', callback_data: 'd1_f_1_q_16' },
        ]
    ],
    f_2: [
        [
        ...
        [
            { text: '1', callback_data: 'd1_f_2_q_1' },
            { text: '2', callback_data: 'd1_f_2_q_2' },
            { text: '3', callback_data: 'd1_f_2_q_3' },
            { text: '4', callback_data: 'd1_f_2_q_4' },
            { text: '5', callback_data: 'd1_f_2_q_5' },
            { text: '6', callback_data: 'd1_f_2_q_6' },
        ],
        [
            { text: '7', callback_data: 'd1_f_2_q_7' },
            { text: '8', callback_data: 'd1_f_2_q_8' },
            { text: '9', callback_data: 'd1_f_2_q_9' },
            { text: '10', callback_data: 'd1_f_2_q_10' },
            { text: '11', callback_data: 'd1_f_2_q_11' },
            { text: '12', callback_data: 'd1_f_2_q_12' },
        ]
    ]
};
